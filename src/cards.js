...
function buildTacticCardFromTactic(tactic) {
  return {
    ...
    notes: tactic.notes || "",
    damageValue: tactic.damageValue,
    hitDamage: tactic.hitDamage,
    hitCount: tactic.hitCount,
    selectionCount: tactic.selectionCount,
    spawnBlueprintId: tactic.spawnBlueprintId || null,
    passiveOnly: true
  };
}
