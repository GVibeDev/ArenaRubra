...
function runPrecheck(options = {}) {
  ...
  try {
    ...
    const cameraApiF9O2 = ["cameraFocusHex", "cameraFocusUnit", "cameraFocusHQ", "cameraSetZoom", "cameraResetView", "cameraLockInput"];
    ...
    if (typeof cameraDiagnostics !== "function" || typeof initializeCameraInteraction !== "function") problems.push("Runtime camera F9O2 incompleto.");
      ...
      info.push("F9O2: pan mouse/touch, zoom wheel/pinch, controlli Fit/Centra e API focus tutorial disponibili.");
    }
