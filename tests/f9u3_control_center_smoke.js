...
ok(build.includes('version: "C2-STABLE-1-F9V3b-APK-M4c"'), "versione F9T2c");
...
ok(build.includes('buildChannel: "starter2-tutorial-hardening-v3b"'), "canale candidato F9T2c");
