...
ok(build.includes('C2-STABLE-1-F9O4f-APK-M4c'), "metadata F9O4f");
ok(build.includes('logicBaseline: "C2-STABLE-1-F9O4e-APK-M4c"'), "baseline F9O4e");
ok(build.includes("Real Art Thumbnail Cache Finalization Hotfix"), "nome build");
