...
const victoryLifecycle=fs.readFileSync(path.join(root,"src/rules/victory_lifecycle.js"),"utf8");
ok(victoryLifecycle.includes('eliminatePlayer(defender, occupant.side, "qg")') && rules.includes('victoryLifecycleService().checkVictory()'),"HQ victory logic remains present behind facade");
