...
const apiNames = ["cameraFocusHex", "cameraFocusUnit", "cameraFocusHQ", "cameraSetZoom", "cameraResetView", "cameraLockInput", "cameraDiagnostics"];
...
ok(mobile.includes('apkM4Camera.mode !== "manual"'), "render mobile preserva camera manuale");
ok(mobile.includes('preserveCamera:true'), "resize mobile preserva camera");
ok(camera.includes('active.mode'), "HUD usa camera attiva");
ok(build.includes('C2-STABLE-1-F9O2a-APK-M4c'), "metadata F9O2a");
