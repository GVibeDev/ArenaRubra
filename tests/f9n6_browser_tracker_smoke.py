...
with sync_playwright() as p:
    ...
    """)
    browser.close()
ok=(not errors and result["build"] in {"C2-STABLE-1-F9N6-APK-M4c","C2-STABLE-1-F9O4a-APK-M4c","C2-STABLE-1-F9O4b-APK-M4c","C2-STABLE-1-F9O4c-APK-M4c","C2-STABLE-1-F9O4d-APK-M4c"} and result["active"] and result["missionId"]=="NXMSN01" and result["objectiveCount"]==3 and result["streak"]>=2 and result["completed"] and result["precheckRendererOk"] and result["missionEvents"]>0)
