...
ok(build.includes('logicBaseline: "C2-STABLE-1-F9O4e-APK-M4c"') || build.includes('logicBaseline: "C2-STABLE-1-F9O4d-APK-M4c"') || build.includes('logicBaseline: "C2-STABLE-1-F9O4c-APK-M4c"') || build.includes('logicBaseline: "C2-STABLE-1-F9O4a-APK-M4c"') || build.includes('logicBaseline: "C2-STABLE-1-F9O4-APK-M4c"') || build.includes('logicBaseline: "C2-STABLE-1-F9O3-APK-M4c"') || build.includes('logicBaseline: "C2-STABLE-1-F9O2e-APK-M4c"') || build.includes('logicBaseline: "C2-STABLE-1-F9O2d-APK-M4c"') || build.includes('logicBaseline: "C2-STABLE-1-F9O2c-APK-M4c"'), "baseline F9O2c");
