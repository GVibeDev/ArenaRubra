...
const victoryLifecycle = read("src/rules/victory_lifecycle.js");
...
ok(victoryLifecycle.includes('audioHandleMatchEnd({') && rules.includes('arenaAudioHandleMatchEnd(payload)'), "hook fine partita dietro facade regole");
